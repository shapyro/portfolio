...
class About extends Component {
  render() {
    return (
      <div className="about">
        <h3 className="hello">Hello, my name is Brandon Shapiro.</h3>
        <div className="about-content">
          ...
          <div className="line">
            ...
            <a href="mailto:shapiro.brandonf@gmail.com" className="highlight email">shapiro.brandonf@gmail.com</a>
          </div>

          <div className="line status">I am currently available for freelance work.</div>
        </div>
      </div>
